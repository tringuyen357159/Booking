        ...
        return (
            <div className="header-container">
                ...
                <div className="header-languages">
                    ...
                    <span 
                        className={ LANGUAGES.VI === language ? 'header-languages-vi active' : 'header-languages-vi' }
                        onClick={() => this.handleChangeLanguages(LANGUAGES.VI)}
                    >
                        VI
                    </span>
                    <span 
                        className={ LANGUAGES.EN === language ? 'header-languages-en active' : 'header-languages-en' }
